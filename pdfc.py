        ...
        for page in pdf_reader.pages:
            ...
            for line in lines:
                ...
                #get phone numbers
                    ...
                    split_data = line.split('E-mail:')
                    if len(split_data) > 1:
                        secondary_email = split_data[1].strip()
                        c1_data['Secondary Email'] = c2_data['Secondary Email'] = secondary_email if len(secondary_email) > 2 else 'N/A'
                    else:
                        #Handle or log the unexpected format or set it to default value
                        c1_data['Secondary Email'] = c2_data['Secondary Email'] = 'N/A'
                        print(f'Unexpected format for secondary email in line: {line}')
